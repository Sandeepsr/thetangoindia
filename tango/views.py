...
from config_settings import TANGO_LOCATION
...
class PastEventsPage(generic.TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['PastEvents'] = FBEvents.objects.filter(
            Start_Time__lt=self.sdate)
        return context
...
class EventsPage(generic.TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['Next2weeks'] = FBEvents.objects.filter(
            Start_Time__range=[self.sdate, self.edate]).distinct()
